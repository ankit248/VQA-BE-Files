...
sys.path.append(os.path.abspath("/usr/VQA_Den/VizWiz-VQA-PyTorch-master/datasets"))
sys.path.append(os.path.abspath("/usr/VQA_Den/VizWiz-VQA-PyTorch-master/preprocessing"))

from features import FeaturesDataset
from preprocessing_utils import prepare_questions, prepare_answers, encode_question, encode_answers
